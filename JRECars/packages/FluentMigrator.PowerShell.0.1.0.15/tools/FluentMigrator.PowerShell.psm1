...
function Get-DatabaseMigration
{
    ...
    ExecuteMigrateCommand "listmigrations" $Assembly $Provider $ConnectionString $ConnectionStringName $ConnectionStringConfigurationPath $Namespace $Nested $TransactionPerSession $Timeout $WorkingDirectory $Tag $Context $null $null $null $null $null $null $null $Assemblies -WhatIf:$WhatIf;
}
...
function Update-Database
{
    ...
    ExecuteMigrateCommand "migrate:up" $Assembly $Provider $ConnectionString $ConnectionStringName $ConnectionStringConfigurationPath $Namespace $Nested $TransactionPerSession $Timeout $WorkingDirectory $Tag $Context $Profile $Version $Preview $null $Output $OutputFileName $DeleteBeforeMigrating $Assemblies -WhatIf:$WhatIf;
}
...
function Rollback-Database
{
    ...
    ExecuteMigrateCommand "rollback" $Assembly $Provider $ConnectionString $ConnectionStringName $ConnectionStringConfigurationPath $Namespace $Nested $TransactionPerSession $Timeout $WorkingDirectory $Tag $Context $null $Version $Preview $steps $Output $OutputFileName $null $Assemblies -WhatIf:$WhatIf;
}
